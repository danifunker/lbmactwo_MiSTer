...
"""Generate 32x32 color icons (icl4 + ICN# + mask) for all three benches:
  - CPU bench:     green chip outline, "CPU 68020 BENCH"
  - FPU bench:     red   chip outline, "FPU 68881 BENCH"
  - CPU+FPU:       half green / half red, "MACII CPU FPU BENCH"
...
def main():
    # CPU bench: green chip, "CPU / 68020 / BENCH"
    ...
    # FPU bench: red chip, "FPU / 68881 / BENCH"
    emit_icon_set("FPU bench",
        [
            (6,  10, "FPU"),
            (13,  6, "68881"),
            (20,  6, "BENCH"),
        ],
        color_left=COLOR_RED, color_right=COLOR_RED)

    # CPU+FPU bench: split chip (green left half, red right), "MACII / CPU/FPU / BENCH"
    emit_icon_set("CPU+FPU bench",
        [
            (6,   6, "MACII"),
            (13,  4, "CPU/FPU"),
            (20,  6, "BENCH"),
        ],
        color_left=COLOR_GREEN, color_right=COLOR_RED)
