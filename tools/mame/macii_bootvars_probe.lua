...
local function log(kind)
	local q = u32(0x030a)
	print(string.format(
		"MAME_BOOTVARS_%s frame=%d pc=%s tick016A=%s D0=%s D1=%s D5=%s D6=%s A2=%s A3=%s A4=%s W017A=%04X B0B22=%02X B0B2E=%02X B0C2F=%02X W0D24=%04X W0D28=%04X W09FA=%04X W09FC=%04X W09FE=%04X W0A00=%04X W0A02=%04X L08EE=%s L0D10=%s L0D14=%s L030A=%s Q_00=%s Q_04=%04X Q_06=%04X Q_08=%04X Q_0A=%04X Q_0C=%s A2_00=%s A2_04=%04X A2_06=%04X A2_08=%04X A2_0A=%04X A4_00=%s A4_04=%04X A4_06=%04X A4_08=%04X A4_0A=%04X A4_10=%s A4_14=%04X A4_18=%s A4_1C=%04X A4_20=%s A4_60=%04X A4_61=%02X",
		kind, frames, hex(reg("CURPC")), hex(u32(0x016a)), hex(reg("D0")), hex(reg("D1")),
		hex(reg("D5")), hex(reg("D6")), hex(reg("A2")), hex(reg("A3")), hex(reg("A4")),
		u16(0x017a), u8(0x0b22), u8(0x0b2e), u8(0x0c2f),
